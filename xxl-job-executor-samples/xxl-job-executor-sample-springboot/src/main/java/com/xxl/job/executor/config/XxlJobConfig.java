 ...
 * XxlJobSpringExecutor} bean that manages job execution and communication with the admin scheduler.
 *
 ...
 *       Example: {@code http://localhost:18080/xxl-job-admin}
 ...
 *       match the executor group configured in admin. Example: {@code xxl-job-executor-sample}
 ...
 *
 * <p>The executor automatically scans Spring beans for methods annotated with {@code @XxlJob} and
