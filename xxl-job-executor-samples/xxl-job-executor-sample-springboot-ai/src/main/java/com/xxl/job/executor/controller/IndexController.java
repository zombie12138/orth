...
public class IndexController {
    ...
    public String simpleChat(
        ...
        ChatClient ollamaChatClient =
                ChatClient.builder(ollamaChatModel)
                        ...
                        .defaultOptions(
                                OllamaChatOptions.builder().model(modle).build()) // assign model
                        .build();

        // call ollama
        String response = ollamaChatClient.prompt(prompt).user(input).call().content();
    ...
    public Flux<String> streamChat(
        ...
        // call ollama
        return ollamaChatClient.prompt(prompt).user(input).stream().content();
    }
