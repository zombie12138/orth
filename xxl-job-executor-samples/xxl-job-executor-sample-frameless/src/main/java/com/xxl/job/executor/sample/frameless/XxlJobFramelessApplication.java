 ...
 * <h2>Configuration:</h2>
 *
 * <p>All configuration is loaded from {@code xxl-job-executor.properties} on the classpath:
 *
 * <pre>
 ...
 *
 * <ol>
 *   <li>Application starts and calls {@code FrameLessXxlJobConfig.initXxlJobExecutor()}
 ...
 *
 * # Run standalone
 * java -jar xxl-job-executor-sample-frameless-*.jar
 *
 * # Or with explicit classpath
 * java -cp "target/xxl-job-executor-sample-frameless-*.jar:target/lib/*" \
 *   com.xxl.job.executor.sample.frameless.XxlJobFramelessApplication
 * </pre>
 *
 ...
 * @see FrameLessXxlJobConfig
 * @see com.xxl.job.executor.sample.frameless.jobhandler.SampleXxlJob
 */
