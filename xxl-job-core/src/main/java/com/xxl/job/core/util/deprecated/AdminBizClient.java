...
// handleCallbackRequestList, String.class);
//    }
//
//    @Override
...
// registryRequest, String.class);
//    }
//
//    @Override
//    public Response<String> registryRemove(RegistryRequest registryRequest) {
//        return XxlJobRemotingUtil.postBody(addressUrl + "api/registryRemove", accessToken,
// timeout, registryRequest, String.class);
//    }
//
// }
