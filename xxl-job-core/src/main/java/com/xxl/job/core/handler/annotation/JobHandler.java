 ...
 * been replaced by {@link XxlJob} which provides method-level granularity and better Spring
 * integration.
 *
 ...
 *   <li>Replacement: {@link XxlJob}
 * </ul>
 *
 * @author xuxueli
 * @since 1.0.0
 * @deprecated Use {@link XxlJob} instead for method-level job handler registration
 */
