...
// triggerRequest, String.class);
//    }
//
//    @Override
//    public Response<String> kill(KillRequest killRequest) {
//        return XxlJobRemotingUtil.postBody(addressUrl + "kill", accessToken, timeout, killRequest,
// String.class);
//    }
//
//    @Override
//    public Response<LogResult> log(LogRequest logRequest) {
//        return XxlJobRemotingUtil.postBody(addressUrl + "log", accessToken, timeout, logRequest,
// LogResult.class);
//    }
//
// }
