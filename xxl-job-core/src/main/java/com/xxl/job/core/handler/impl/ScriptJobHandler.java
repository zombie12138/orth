...
public class ScriptJobHandler extends IJobHandler {
    ...
    public void execute() throws Exception {
        ...
        XxlJobHelper.log("----------- orth script file: " + scriptFileName + " -----------");
        int exitValue =
        ...
        if (exitValue == EXIT_CODE_SUCCESS) {
            ...
            XxlJobHelper.handleFail("orth script execution failed with exit code: " + exitValue);
        }
    }
    ...
    private String buildScriptFilePath() {
        return XxlJobFileAppender.getGlueSrcPath()
                + File.separator
                + jobId
                + "_"
                + glueUpdatetime
    ...
    private void ensureScriptFileExists(String scriptFileName) throws Exception {
        ...
        if (!scriptFile.exists()) {
            ...
            XxlJobHelper.log("orth script file created (cache miss): " + scriptFileName);
        } else {
            XxlJobHelper.log("orth script file cached (cache hit): " + scriptFileName);
        }
    }
    ...
    private String[] buildScriptParameters() {
        ...
        scriptParams[0] = XxlJobHelper.getJobParam() != null ? XxlJobHelper.getJobParam() : "";
