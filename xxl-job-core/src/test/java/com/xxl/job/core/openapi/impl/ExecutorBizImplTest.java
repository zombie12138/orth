...
class ExecutorBizImplTest extends AbstractUnitTest {
    ...
    public void setUp() {
        ...
        XxlJobExecutor.registryJobHandler(TEST_HANDLER_NAME, testJobHandler);
    }

    @AfterEach
    public void tearDown() {
        // Clean up job threads
        XxlJobExecutor.removeJobThread(TEST_JOB_ID, "test cleanup");
        super.tearDown();
    }
    ...
    void testRun_beanGlueType_handlerUpdate_shouldKillOldThread() throws Exception {
        ...
        XxlJobExecutor.registryJobHandler(TEST_HANDLER_NAME, newHandler);
    ...
    void testRun_groovyGlueType_firstRun_shouldExecute() throws Exception {
        ...
        String groovyCode =
                "import com.xxl.job.core.handler.IJobHandler\n"
                        ...
                        + "        XxlJobHelper.handleSuccess('Groovy executed')\n"
                        + "    }\n"
                        + "}";
    ...
    void testRun_groovyGlueType_codeUpdate_shouldReloadHandler() throws Exception {
        ...
        String groovyCode1 =
                "import com.xxl.job.core.handler.IJobHandler\n"
                        ...
                        + "    @Override\n"
                        + "    void execute() throws Exception {\n"
                        + "        XxlJobHelper.handleSuccess('Version 1')\n"
                        + "    }\n"
                        + "}";
        ...
        String groovyCode2 =
                "import com.xxl.job.core.handler.IJobHandler\n"
                        ...
                        + "    @Override\n"
                        + "    void execute() throws Exception {\n"
                        + "        XxlJobHelper.handleSuccess('Version 2')\n"
                        + "    }\n"
                        + "}";
    ...
    static class TestJobHandler extends IJobHandler {
        ...
        public void execute() throws Exception {
            ...
            XxlJobHelper.handleSuccess("Test execution " + executionCount.get());
            if (executionTime > 0) {
