 ...
 *   <li>Use @OrthJob annotation to register job handlers
 ...
 *   <li>OrthJobSpringExecutor starts successfully and registers with admin server
 *   <li>Job handlers are properly discovered via @OrthJob annotation scanning
...
public class OrthExecutorExampleBootApplicationTests {
     ...
     *   <li>OrthJobSpringExecutor bean is created and initialized
     ...
     *
     * <ul>
     *   <li>All @OrthJob annotated methods are discovered and registered
     ...
     *     IJobHandler handler = orthJobSpringExecutor.loadJobHandler("demoJobHandler");
    ...
    public void shouldRegisterJobHandlers() {
        ...
        // Verify @OrthJob("demoJobHandler") and similar handlers are registered
