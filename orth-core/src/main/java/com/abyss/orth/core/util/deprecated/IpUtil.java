...
/**
 * Deprecated IP address detection and validation utilities.
 *
 * <p>This utility class provided network interface discovery, IP address validation (IPv4/IPv6),
 * and local address detection with caching. It included logic for filtering virtual interfaces and
 * normalizing IPv6 scope IDs.
 *
 * @deprecated This utility is deprecated and will be removed in a future version. Use the xxl-tool
 *     library's network utilities (com.xxl.tool.net.IpUtil) instead, which provide the same
 *     functionality with better IPv6 support and modern network API usage.
