...
public class OrthJobContext {
    ...
    private static final InheritableThreadLocal<OrthJobContext> contextHolder =
            new InheritableThreadLocal<>();

    /**
     * Sets the job context for the current thread.
     *
     * @param orthJobContext the context to set
     */
    public static void setOrthJobContext(OrthJobContext orthJobContext) {
        contextHolder.set(orthJobContext);
    }
     ...
     */
    public static OrthJobContext getOrthJobContext() {
