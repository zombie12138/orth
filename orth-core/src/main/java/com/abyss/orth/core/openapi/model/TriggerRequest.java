 ...
 * Converted to {@link com.abyss.orth.core.context.OrthJobContext}
 *
 * @author xuxueli
 * @since 1.0.0
 */
public class TriggerRequest implements Serializable {
    ...
    /** Job ID (primary key from orth_job_info table) */
    private int jobId;
     ...
     *
     * <p>Examples: "sampleOrthJob" (Bean), "GLUE(Shell)" (Script), "666_1234567890.py" (GLUE
     * Python)
     */
     ...
     * com.abyss.orth.core.constant.ExecutorBlockStrategyEnum})
     */
    ...
    /** Log ID (primary key from orth_job_log table) */
    private long logId;
     ...
     * (from {@link com.abyss.orth.core.glue.GlueTypeEnum})
     */
     ...
     *
     * <p>Max size: 64KB (enforced by orth_job_info.job_source column)
     */
