...
public class JobLogReportHelper {
    ...
    public void start() {
                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                while (!toStop) {
                                    ...
                                    try {
                                        ...
                                        for (int i = 0; i < 3; i++) {
                                            ...
                                            if (triggerCountMap != null
                                                ...
                                                orthJobLogReport.setRunningCount(
                                                        triggerDayCountRunning);
                                                orthJobLogReport.setSuccessCount(
                                                        triggerDayCountSuc);
                                            ...
                                            OrthAdminBootstrap.getInstance()
                                                    ...
                                                    .saveOrUpdate(
                                                            orthJobLogReport); // 0-fail; 1-save
                                            // suc;
                                            // 2-update suc;
                                            /*if (ret < 1) {
                                                OrthAdminBootstrap.getInstance().getJobLogReportMapper().save(orthJobLogReport);
                                            }*/
                                        }
                                    ...
                                    try {
                                        if (OrthAdminBootstrap.getInstance().getLogretentiondays()
                                                        > 0
                                        ...
                                        if (!toStop) {
                                            logger.error(
                                                    ">>>>>>>>>>> orth, JobLogReportHelper(log-clean) error:{}",
                                                    e.getMessage(),
                                                    e);
                                        }
                                    }
        ...
        logReportThread.setName("orth, admin JobLogReportHelper");
