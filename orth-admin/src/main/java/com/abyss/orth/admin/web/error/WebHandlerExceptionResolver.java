package com.abyss.orth.admin.web.error;
 ...
 * (OrthJobException) are logged at debug level, while unexpected exceptions are logged as errors.
 *
...
public class WebHandlerExceptionResolver {
    ...
    @ExceptionHandler(OrthJobException.class)
    public Response<String> handleOrthJobException(OrthJobException ex) {
