...
/**
 * Integration tests for {@link JobGroupMapper}.
 *
...
public class JobGroupMapperTest {
     ...
     */
    private JobGroup createTestGroup() {
     ...
     */
    private void updateGroupProperties(JobGroup group) {
