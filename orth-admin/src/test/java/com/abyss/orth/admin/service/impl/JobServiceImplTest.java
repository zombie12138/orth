...
/**
 * Unit tests for {@link JobServiceImpl} private helper methods.
 *
...
class JobServiceImplTest {
    ...
    void setUp() throws Exception {
        ...
        sanitizeMethod =
                JobServiceImpl.class.getDeclaredMethod(
    ...
    void updateJobFields_clearsSuperTaskId_whenNull() throws Exception {
        Method updateMethod =
                JobServiceImpl.class.getDeclaredMethod(
                        "updateJobFields", JobInfo.class, JobInfo.class, long.class);
        updateMethod.setAccessible(true);

        JobInfo existing = createJobInfo(5, 10); // has superTaskId=10
        JobInfo newInfo = createJobInfo(5, null); // clearing superTaskId
    ...
    void updateJobFields_clearsSelfReference() throws Exception {
        ...
        JobInfo existing = createJobInfo(5, 10);
        JobInfo newInfo = createJobInfo(5, 5); // self-reference
    ...
    void updateJobFields_keepsValidSuperTaskId() throws Exception {
        ...
        JobInfo existing = createJobInfo(5, 0);
        JobInfo newInfo = createJobInfo(5, 10); // setting valid superTaskId
    ...
    private JobInfo createJobInfo(int id, Integer superTaskId) {
