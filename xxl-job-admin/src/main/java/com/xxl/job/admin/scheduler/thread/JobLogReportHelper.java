                                ...
                                while (!toStop) {
                                    ...
                                    try {
                                        ...
                                        for (int i = 0; i < 3; i++) {
                                            ...
                                            // do refresh:
                                            XxlJobAdminBootstrap.getInstance()
                                                    .getXxlJobLogReportMapper()
                                                    .saveOrUpdate(
                                                            xxlJobLogReport); // 0-fail; 1-save suc;
                                            // 2-update suc;
                                            /*if (ret < 1) {
                                        ...
                                        if (!toStop) {
                                            logger.error(
                                                    ">>>>>>>>>>> xxl-job, JobLogReportHelper(log-report refresh) error:{}",
                                                    e.getMessage(),
                                                    e);
                                        }
                                    }
                                    ...
                                    try {
                                        if (XxlJobAdminBootstrap.getInstance().getLogretentiondays()
                                                        > 0
                                        ...
                                        if (!toStop) {
                                            logger.error(
                                                    ">>>>>>>>>>> xxl-job, JobLogReportHelper(log-clean) error:{}",
                                                    e.getMessage(),
                                                    e);
                                        }
                                    }
