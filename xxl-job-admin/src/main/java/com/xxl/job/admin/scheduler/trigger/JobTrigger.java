...
public class JobTrigger {
     ...
     */
    private int resolveFailRetryCount(int requestedRetryCount, XxlJobInfo jobInfo) {
     ...
     */
    private void applyAddressOverride(XxlJobGroup group, String addressList) {
    ...
    private void processTrigger(
        ...
        XxlJobLog jobLog = createJobLog(jobInfo, scheduleTime);
     ...
     */
    private XxlJobLog createJobLog(XxlJobInfo jobInfo, Long scheduleTime) {
    ...
    private Response<String> executeTrigger(TriggerRequest triggerRequest, String address) {
        if (address == null) {
            return Response.of(XxlJobContext.HANDLE_CODE_FAIL, MSG_ADDRESS_ROUTER_FAIL);
        }
